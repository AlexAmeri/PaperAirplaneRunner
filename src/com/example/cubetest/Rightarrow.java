...
private int[] textures = new int[1];
	...
	public Rightarrow(boolean correct){
		...
		public void loadGLTexture(GL10 gl, Context context) {
			...
			if(correctAns)
			is = context.getResources().openRawResource(R.drawable.righttex);
			
			if(!correctAns)
			is = context.getResources().openRawResource(R.drawable.wrongtex);
